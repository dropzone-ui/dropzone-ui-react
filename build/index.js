...
var Info = function (props) {
    ...
    return (React__default['default'].createElement("svg", { style: onClick ? { cursor: "pointer" } : {}, xmlns: "http://www.w3.org/2000/svg", height: finalSize + "px", viewBox: "0 0 24 24", width: finalSize + "px", fill: color ? color : "#000000", onClick: function () { return onClick === null || onClick === void 0 ? void 0 : onClick(); } },
        React__default['default'].createElement("path", { d: "M0 0h24v24H0V0z", fill: "none" }),
        React__default['default'].createElement("path", { d: "M12 4c-4.41 0-8 3.59-8 8s3.59 8 8 8 8-3.59 8-8-3.59-8-8-8zm1 13h-2v-6h2v6zm0-8h-2V7h2v2z", fill: colorFill ? colorFill : "none", opacity: ".7" }),
        React__default['default'].createElement("path", { d: "M11 7h2v2h-2zm0 4h2v6h-2zm1-9C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z" })));
};
...
var CheckCircle = function (props) {
    ...
    return (React__default['default'].createElement("svg", { className: className || "", style: onClick ? __assign$2({}, __assign$2({ cursor: "pointer" }, finalStyle)) : finalStyle, onClick: function () { return onClick === null || onClick === void 0 ? void 0 : onClick(); }, xmlns: "http://www.w3.org/2000/svg", height: finalSize + "px", viewBox: "0 0 24 24", width: finalSize + "px", fill: color ? color : "#000000" },
        React__default['default'].createElement("path", { d: "M0 0h24v24H0z", fill: colorFill ? colorFill : "none" }),
        React__default['default'].createElement("path", { d: "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z" })));
};
...
var DoDisturb = function (props) {
    ...
    var finalSize = parseSize(size);
    var finalStyle = style ? style : {};
    return (React__default['default'].createElement("svg", { className: className || "", style: onClick ? __assign$2({}, __assign$2({ cursor: "pointer" }, finalStyle)) : finalStyle, onClick: function () { return onClick === null || onClick === void 0 ? void 0 : onClick(); }, xmlns: "http://www.w3.org/2000/svg", height: finalSize ? finalSize + "px" : "24px", viewBox: "0 0 24 24", width: finalSize ? finalSize + "px" : "24px", fill: color ? color : "#000000" },
        React__default['default'].createElement("path", { d: "M0 0h24v24H0V0z", fill: "none" }),
        React__default['default'].createElement("path", { d: "M12 4c-4.41 0-8 3.59-8 8s3.59 8 8 8 8-3.59 8-8-3.59-8-8-8z", opacity: ".4" }),
        React__default['default'].createElement("path", { d: "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.42 0-8-3.58-8-8 0-1.85.63-3.55 1.69-4.9L16.9 18.31C15.55 19.37 13.85 20 12 20zm6.31-3.1L7.1 5.69C8.45 4.63 10.15 4 12 4c4.42 0 8 3.58 8 8 0 1.85-.63 3.55-1.69 4.9z" })));
};
...
var Cancel = function (props) {
    ...
    var finalSize = parseSize(size);
    var finalStyle = style ? style : {};
    return (React__default['default'].createElement("svg", { style: onClick ? __assign$2({}, __assign$2({ cursor: "pointer" }, finalStyle)) : finalStyle, onClick: function (e) { return onClick === null || onClick === void 0 ? void 0 : onClick(e); }, xmlns: "http://www.w3.org/2000/svg", height: finalSize + "px", viewBox: "0 0 24 24", width: finalSize + "px", fill: color ? color : "#000000", className: className || "" },
        React__default['default'].createElement("path", { d: "M0 0h24v24H0V0z", fill: "none", opacity: ".87" }),
        React__default['default'].createElement("path", { d: "M12 4c-4.41 0-8 3.59-8 8s3.59 8 8 8 8-3.59 8-8-3.59-8-8-8zm5 11.59L15.59 17 12 13.41 8.41 17 7 15.59 10.59 12 7 8.41 8.41 7 12 10.59 15.59 7 17 8.41 13.41 12 17 15.59z", fill: colorFill ? colorFill : "none", opacity: ".3" }),
        React__default['default'].createElement("path", { d: "M12 2C6.47 2 2 6.47 2 12s4.47 10 10 10 10-4.47 10-10S17.53 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm3.59-13L12 10.59 8.41 7 7 8.41 10.59 12 7 15.59 8.41 17 12 13.41 15.59 17 17 15.59 13.41 12 17 8.41z" })));
};
...
var Visibility = function (props) {
    ...
    var finalSize = parseSize(size);
    var finalStyle = style ? style : {};
    return (React__default['default'].createElement("svg", { className: className || "", style: onClick ? __assign$2({ cursor: "pointer" }, finalStyle) : finalStyle, xmlns: "http://www.w3.org/2000/svg", height: finalSize + "px", viewBox: "0 0 24 24", width: finalSize + "px", fill: color ? color : "#000000", onClick: function () { return onClick === null || onClick === void 0 ? void 0 : onClick(); } },
        React__default['default'].createElement("path", { d: "M0 0h24v24H0V0z", fill: "none" }),
        React__default['default'].createElement("path", { d: "M12 4c-4.41 0-8 3.59-8 8s3.59 8 8 8 8-3.59 8-8-3.59-8-8-8z", opacity: ".9", fill: colorFill ? colorFill : "none" }),
...
var ViewList = function (props) {
    ...
    var finalSize = parseSize(size);
    var finalStyle = style ? style : {};
    return (React__default['default'].createElement("svg", { style: onClick ? __assign$2({}, __assign$2({ cursor: "pointer" }, finalStyle)) : finalStyle, onClick: function () { return onClick === null || onClick === void 0 ? void 0 : onClick(); }, xmlns: "http://www.w3.org/2000/svg", "enable-background": "new 0 0 24 24", height: finalSize + "px", viewBox: "0 0 24 24", width: finalSize + "px", fill: color ? color : "#000000", className: className || "" },
        React__default['default'].createElement("rect", { fill: colorFill || "none", height: size || "24", width: size || "24" }),
        React__default['default'].createElement("path", { d: "M20,4H4C2.9,4,2,4.9,2,6v12c0,1.1,0.9,2,2,2h16c1.1,0,2-0.9,2-2V6C22,4.9,21.1,4,20,4z M8,18H4V6h4V18z M14,18h-4V6h4V18z M20,18h-4V6h4V18z" })));
};
...
var ViewGrid = function (props) {
    ...
    return (React__default['default'].createElement("svg", { style: onClick ? __assign$2({}, __assign$2({ cursor: "pointer" }, finalStyle)) : finalStyle, onClick: function () { return onClick === null || onClick === void 0 ? void 0 : onClick(); }, xmlns: "http://www.w3.org/2000/svg", "enable-background": "new 0 0 24 24", height: finalSize + "px", viewBox: "0 0 24 24", width: finalSize + "px", fill: color ? color : "#000000", className: className || "" },
        React__default['default'].createElement("g", null,
            React__default['default'].createElement("path", { d: "M0,0h24v24H0V0z", fill: "none" })),
        React__default['default'].createElement("g", null,
            React__default['default'].createElement("path", { d: "M20,4H4C2.9,4,2,4.9,2,6v12c0,1.1,0.9,2,2,2h16c1.1,0,2-0.9,2-2V6C22,4.9,21.1,4,20,4z M8,11H4V6h4V11z M14,11h-4V6h4V11z M20,11h-4V6h4V11z M8,18H4v-5h4V18z M14,18h-4v-5h4V18z M20,18h-4v-5h4V18z" }))));
};
...
var UploadDone = function (props) {
    ...
    var finalSize = parseSize(size);
    var finalStyle = style ? style : {};
    return (React__default['default'].createElement("svg", { className: className || "", style: onClick ? __assign$2({}, __assign$2({ cursor: "pointer" }, finalStyle)) : finalStyle, onClick: function () { return onClick === null || onClick === void 0 ? void 0 : onClick(); }, xmlns: "http://www.w3.org/2000/svg", "enable-background": "new 0 0 24 24", height: finalSize + "px", viewBox: "0 0 24 24", width: finalSize + "px", fill: color ? color : "#000000" },
        React__default['default'].createElement("g", null,
            React__default['default'].createElement("rect", { fill: colorFill ? colorFill : "none", height: finalSize, width: finalSize })),
        React__default['default'].createElement("g", null,
            React__default['default'].createElement("g", null,
                React__default['default'].createElement("polygon", { points: "20.13,5.41 18.72,4 9.53,13.19 5.28,8.95 3.87,10.36 9.53,16.02" }),
                React__default['default'].createElement("rect", { height: "2", width: "14", x: "5", y: "18" })))));
};
...
var UploadError = function (props) {
    ...
    return (React__default['default'].createElement("svg", { className: className || "", style: onClick ? __assign$2({}, __assign$2({ cursor: "pointer" }, finalStyle)) : finalStyle, onClick: function () { return onClick === null || onClick === void 0 ? void 0 : onClick(); }, xmlns: "http://www.w3.org/2000/svg", height: finalSize + "px", viewBox: "0 0 24 24", width: finalSize + "px", fill: color ? color : "#000000" },
        React__default['default'].createElement("rect", { fill: colorFill ? colorFill : "none", height: finalSize, width: finalSize }),
        React__default['default'].createElement("path", { d: "M18,15.17V15h2v2.17L18,15.17z M15.41,12.59L17,11l-1.41-1.41L14,11.17L15.41,12.59z M13,10.17V4h-2v4.17L13,10.17z M21.19,21.19l-1.78-1.78L2.81,2.81L1.39,4.22l6.19,6.19L7,11l5,5l0.59-0.59L15.17,18H6v-3H4v3c0,1.1,0.9,2,2,2h11.17l2.61,2.61 L21.19,21.19z" })));
};
...
var Upload = function (props) {
    ...
    return (React__default['default'].createElement("svg", { style: onClick ? __assign$2({}, __assign$2({ cursor: "pointer" }, finalStyle)) : finalStyle, onClick: function () { return onClick === null || onClick === void 0 ? void 0 : onClick(); }, xmlns: "http://www.w3.org/2000/svg", "enable-background": "new 0 0 24 24", height: finalSize + "px", viewBox: "0 0 24 24", width: finalSize + "px", fill: color ? color : "#000000", className: className || "" },
        React__default['default'].createElement("g", null,
            React__default['default'].createElement("rect", { fill: colorFill || "none", height: size || "24", width: size || "24" })),
        React__default['default'].createElement("g", null,
            React__default['default'].createElement("path", { d: "M18,15v3H6v-3H4v3c0,1.1,0.9,2,2,2h12c1.1,0,2-0.9,2-2v-3H18z M7,9l1.41,1.41L11,7.83V16h2V7.83l2.59,2.58L17,9l-5-5L7,9z" }))));
};
...
var DropzoneHeader = function (props) {
    ...
    var makeHeader = function () {
        ...
        if (onUploadStart && urlPresent && numberOfValidFiles) {
            result.push(React__default['default'].createElement(React__default['default'].Fragment, null,
                "Start Uploading",
                React__default['default'].createElement(Upload, { color: "#646c7f", onClick: handleStartUploading }),
                " | "));
        }
        if (maxFileSize) {
        ...
        if (onChangeView) {
            result.push(React__default['default'].createElement(React__default['default'].Fragment, null, view !== "grid" ? (React__default['default'].createElement(ViewGrid, { onClick: function () {
                    onChangeView === null || onChangeView === void 0 ? void 0 : onChangeView("grid");
                }, color: "#646c7f" })) : (React__default['default'].createElement(ViewList, { onClick: function () {
                    onChangeView === null || onChangeView === void 0 ? void 0 : onChangeView("list");
                }, color: "#646c7f" }))));
        }
        if (onReset) {
            result.push(React__default['default'].createElement(Cancel, { color: "#646c7f", 
                //color="rgba(255,255,255,0.8)"
                onClick: handleReset, colorFill: "rgba(255,255,255,0.8)" }));
        }
        return result;
    };
    return (React__default['default'].createElement("div", { className: "dz-ui-header", onClick: function (e) {
            e.stopPropagation();
        } }, makeHeader().map(function (HeaderItem) { return (React__default['default'].createElement(React__default['default'].Fragment, null, HeaderItem)); })));
};

var DropzoneFooter = function (props) {
    var accept = props.accept, message = props.message;
    return (React__default['default'].createElement("div", { className: "dz-ui-footer", onClick: undefined }, message
        ? message
        : !accept
...
var FileItemContainer = function (props) {
    ...
    return (React__default['default'].createElement("div", { className: "file-item-list-container file-item-list-" + finalView }, children));
};

var DropzoneLabel = function (props) {
    var children = props.children;
    return React__default['default'].createElement("div", { className: "dz-ui-label" }, children);
};
                ...
                return __generator$1(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            return [3 /*break*/, 7];
                        case 1: return [4 /*yield*/, axios__default['default'].post(url, formData, configParams)];
                        case 2:
                            response = _b.sent();
                            return [3 /*break*/, 9];
                        case 3: return [4 /*yield*/, axios__default['default'].patch(url, formData, configParams)];
                        case 4:
                            response = _b.sent();
                            return [3 /*break*/, 9];
                        case 5: return [4 /*yield*/, axios__default['default'].put(url, formData, configParams)];
                        case 6:
                            response = _b.sent();
                            return [3 /*break*/, 9];
                        case 7: return [4 /*yield*/, axios__default['default'].post(url, formData, configParams)];
                        case 8:
                            response = _b.sent();
                            _b.label = 9;
                        case 9:
...
var Dropzone = function (props) {
    ...
    var _d = React.useState("grid"), localView = _d[0], setLocalView = _d[1];
    var _e = React.useState(""), localMessage = _e[0], setLocalMessage = _e[1];
    //const [filesUploading, setFilesUploading] = useState<FileValidated[]>([]);
    //ClassName for dynamic style
    var _f = React.useState(false), onUploadStart = _f[0], setOnUploadStart = _f[1];
    ...
    //number of files
    var _g = React.useState(0), numberOfValidFiles = _g[0], setNumberOfValidFiles = _g[1];
    React.useEffect(function () {
        if (value) {
            setFiles(value);
    ...
    return (React__default['default'].createElement("div", { className: finalClassName, style: style, onDragOver: handleDragEnter, onClick: clickable ? handleClick : function () { } },
        header && (React__default['default'].createElement(DropzoneHeader, { maxFileSize: maxFileSize, numberOfValidFiles: files.filter(function (x) { return x.valid; }).length, onReset: handleReset, maxFiles: maxFiles, handleReset: handleReset, view: localView, onChangeView: handleChangeView, onUploadStart: !uploadOnDrop ? handleUploadStart : undefined, urlPresent: url !== undefined })),
        value && files && files.length > 0 ? (React__default['default'].createElement(FileItemContainer, { view: localView }, children)) : (React__default['default'].createElement(DropzoneLabel, null, label)),
        footer && (React__default['default'].createElement(DropzoneFooter, { accept: accept, message: onUploadStart ? localMessage : undefined })),
        React__default['default'].createElement("div", { onDragLeave: handleDragLeave, onDrop: kamui, className: "dropzone-ui-layer" + (isDragging ? " drag" : "") }),
        React__default['default'].createElement("input", { ref: inputRef, onChange: handleOnChangeInput, type: "file", accept: accept, style: { display: "none" }, multiple: (maxFiles && maxFiles > 1) || undefined })));
};
...
var Paper = function (props) {
    ...
    return React__default['default'].createElement(component ? component : "div", {
...
var Loader = function (props) {
    ...
    return (React__default['default'].createElement("svg", { width: "80px", height: "60px", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 100 100", preserveAspectRatio: "xMidYMid", className: "lds-colorbar" },
        React__default['default'].createElement("defs", null,
            React__default['default'].createElement("clipPath", { "ng-attr-id": "{{config.cpid}}", x: "0", y: "0", width: "100", height: "100", id: "lds-colorbar-cpid-9d2a9cfa91489" },
                React__default['default'].createElement("path", { d: "M81.3,58.7H18.7c-4.8,0-8.7-3.9-8.7-8.7v0c0-4.8,3.9-8.7,8.7-8.7h62.7c4.8,0,8.7,3.9,8.7,8.7v0C90,54.8,86.1,58.7,81.3,58.7z" }))),
        React__default['default'].createElement("path", { fill: "none", "ng-attr-stroke": "{{config.cf}}", "stroke-width": "2.7928", d: "M82,63H18c-7.2,0-13-5.8-13-13v0c0-7.2,5.8-13,13-13h64c7.2,0,13,5.8,13,13v0C95,57.2,89.2,63,82,63z", stroke: "#5d5d5d" }),
        React__default['default'].createElement("g", { "ng-attr-clip-path": "url(#{{config.cpid}})", "clip-path": "url(#lds-colorbar-cpid-9d2a9cfa91489)" },
            React__default['default'].createElement("g", { transform: "translate(10 0)" },
                React__default['default'].createElement("rect", { x: "-100", y: "0", width: "25", height: "100", "ng-attr-fill": "{{config.c1}}", fill: color }),
                React__default['default'].createElement("rect", { x: "-75", y: "0", width: "25", height: "100", "ng-attr-fill": "{{config.c2}}", fill: hexColorToRGB$1(color, 0.5) }),
                React__default['default'].createElement("rect", { x: "-50", y: "0", width: "25", height: "100", "ng-attr-fill": "{{config.c3}}", fill: color }),
                React__default['default'].createElement("rect", { x: "-25", y: "0", width: "25", height: "100", "ng-attr-fill": "{{config.c4}}", fill: hexColorToRGB$1(color, 0.5) }),
                React__default['default'].createElement("rect", { x: "0", y: "0", width: "25", height: "100", "ng-attr-fill": "{{config.c1}}", fill: color }),
                React__default['default'].createElement("rect", { x: "25", y: "0", width: "25", height: "100", "ng-attr-fill": "{{config.c2}}", fill: hexColorToRGB$1(color, 0.5) }),
                React__default['default'].createElement("rect", { x: "50", y: "0", width: "25", height: "100", "ng-attr-fill": "{{config.c3}}", fill: color }),
                React__default['default'].createElement("rect", { x: "75", y: "0", width: "25", height: "100", "ng-attr-fill": "{{config.c4}}", fill: hexColorToRGB$1(color, 0.5) }),
                React__default['default'].createElement("animateTransform", { attributeName: "transform", type: "translate", calcMode: "linear", values: "0;100", keyTimes: "0;1", dur: "1s", begin: "0s", repeatCount: "indefinite" })))));
};

var FileItemStatus = function (props) {
    var valid = props.valid, uploadStatus = props.uploadStatus, message = props.message;
    return (React__default['default'].createElement(React.Fragment, null, uploadStatus ? (uploadStatus === "uploading" ? (React__default['default'].createElement("div", { className: "file-status-loading" },
        React__default['default'].createElement(Loader, null),
        React__default['default'].createElement("p", null, "uploading "))) : uploadStatus === "success" ? (React__default['default'].createElement("div", { className: "file-status-ok upload" },
        React__default['default'].createElement(UploadDone, { color: "#4caf50", size: "small", 
            //style={styles.icons}
            className: "status-icon" }),
        " ",
        message || "success")) : (React__default['default'].createElement("div", { className: "file-status-error upload" },
        React__default['default'].createElement(UploadError, { color: "#f44336", size: "semi-medium", className: "status-icon" }),
        "upload error"))) : valid ? (React__default['default'].createElement("div", { className: "file-status-ok" },
        " ",
        React__default['default'].createElement(CheckCircle, { color: "#4caf50", size: "small", 
            //style={styles.icons}
            className: "status-icon" }),
        "valid")) : (React__default['default'].createElement("div", { className: "file-status-error" },
        React__default['default'].createElement(DoDisturb, { color: "#f44336", size: "small", className: "status-icon" }),
        "Denied"))));
};
...
var FileItemFullInfoLayer = function (props) {
    ...
    return (React__default['default'].createElement("div", { className: showInfo ? "full-info" : "full-info hide" },
        React__default['default'].createElement("span", { style: {
            ...
            React__default['default'].createElement(Cancel, { style: { margin: 0, right: 0, top: 0 }, color: "rgba(255,255,255,0.8)", onClick: handleCloseInfo, colorFill: "black" }),
            uploadStatus && uploadStatus !== "uploading" ? (React__default['default'].createElement("div", { className: "file-status" },
                React__default['default'].createElement(FileItemStatus, { uploadStatus: uploadStatus }))) : (React__default['default'].createElement("div", { className: "file-status" },
                React__default['default'].createElement(FileItemStatus, { valid: valid })))),
        uploadMessage && React__default['default'].createElement("div", { className: "name" }, uploadMessage),
        React__default['default'].createElement("div", { className: "name" },
            React__default['default'].createElement("span", { className: "sub-label" }, "Name: "),
            fileName),
        React__default['default'].createElement("div", { className: "size" },
            React__default['default'].createElement("span", { className: "sub-label" }, "Size: "),
            " ",
            fileSize),
        React__default['default'].createElement("div", { className: "mime" },
            React__default['default'].createElement("span", { className: "sub-label" }, "Type: "),
            " ",
            fileType)));
};
...
var FileItemMainLayer = function (props) {
    ...
    var _a = React.useState(false), uploadComplete = _a[0], setUploadComplete = _a[1];
    React.useEffect(function () {
    ...
    return (React__default['default'].createElement("div", { className: "info-container" },
        ...
        React__default['default'].createElement("div", { className: "file-item-footer" },
            uploadStatus && uploadComplete ? (React__default['default'].createElement("div", { className: showInfo ? "file-status hide" : "file-status" },
                ...
                React__default['default'].createElement(FileItemStatus, { valid: valid }))),
            React__default['default'].createElement("div", { className: showInfo ? "size-open-info hide" : "size-open-info" },
                React__default['default'].createElement("div", { className: "file-item-size" }, sizeFormatted),
                isImage && onOpenImage && valid && (React__default['default'].createElement(Visibility, { className: "view-in-image-file-item", color: "white", onClick: handleOpenImage, size: "small" })),
                info && (React__default['default'].createElement(Info, { color: "rgba(255,255,255,0.8)", onClick: handleOpenInfo, colorFill: "black" }))))));
};
...
var FileItem = function (props) {
    ...
    var _b = React.useState(false), isImage = _b[0], setIsImage = _b[1];
    var _c = React.useState(""), url = _c[0], setUrl = _c[1];
    var _d = React.useState(undefined), imageSource = _d[0], setImageSource = _d[1];
    var _e = React.useState(false), showInfo = _e[0], setShowInfo = _e[1];
    React.useEffect(function () {
    ...
    return (React__default['default'].createElement(React.Fragment, null, file && (React__default['default'].createElement("div", { className: "dz-ui-file-item-container", onClick: handleClick },
        React__default['default'].createElement("div", { className: "file-item-full-container-container", style: style },
            React__default['default'].createElement(Paper, { className: "file-item-icon-container " + (showInfo ? " hide" : "") },
                React__default['default'].createElement(FileItemImage, { imageSource: imageSource, url: url, fileName: file.name }),
                React__default['default'].createElement(FileItemMainLayer, { showInfo: showInfo, 
                ...
                React__default['default'].createElement(FileItemFullInfoLayer, { showInfo: showInfo, fileName: file.name, fileSize: fileSizeFormater(file.size), fileType: file.type, valid: valid || false, onClose: handleCloseInfo, uploadStatus: uploadStatus, uploadMessage: uploadMessage })),
            React__default['default'].createElement("div", { className: "file-item-name" }, shrinkWord(file.name)))))));
};
/**
 * {fileName === "bottom" && (
...
var InputButton = function (props) {
    ...
    return (React__default['default'].createElement(React.Fragment, null,
        React__default['default'].createElement(MaterialButton, { style: style, color: color, variant: variant, 
            //size={size}
            onClick: clickInput, disabled: disabled, textColor: textColor }, label),
        React__default['default'].createElement("input", { id: id || "", ref: inputRef, onChange: handleOnChange, type: "file", accept: accept, style: { display: "none" }, multiple: multiple })));
};

exports.Dropzone = Dropzone;
exports.DropzoneLabel = DropzoneLabel;
