...
| localization [![new-feature](https://img.shields.io/badge/new-feature-green.svg)](https://img.shields.io/badge/new-feature-green) | `"EN_en"` \| `"ES-es"`           | `"EN_en"`                                                 | El idioma en el cual se presentan las etiuquetas. Solo están soportados `ingles` y `español` por ahora.     |
