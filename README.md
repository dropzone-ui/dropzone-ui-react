...
:heart: it ?, :start: it on :octocat: [Github](https://github.com/dropzone-ui/dropzone-ui) :D or :bird: [Tweet](https://twitter.com/intent/tweet?text=With%20@dropzone_ui,%20my%20@reactjs%20%20web%20app%20becomes%20more%20powerful.%20Thanks,%20@JinJoseManuel%20%F0%9F%A4%A9) about it.
...
- :white_check_mark: File validation
- :art: File Image previews
- :framed_picture: Full screen image previews
- :airplane: File upload
- :cake: Easy to use
...
| localization [![new-feature](https://img.shields.io/badge/new-feature-green.svg)](http://www.dropzone-ui.com) | `"EN-en"` \| `"ES-es"` \| `"FR-fr"` \| `"PT-pt"`               | `"EN-en"`                                                 | The language to present labels. So far, only `English`, `Portuguese`, `French` and `Spanish` are suported.                                                                                                                                                                                                                      |
